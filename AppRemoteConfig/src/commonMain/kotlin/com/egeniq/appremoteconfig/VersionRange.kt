...
internal class VersionRangeSerializer : KSerializer<VersionRange> {
    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("appremoteconfig.VersionRange", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): VersionRange {
        val value = decoder.decodeString()
        return try {
            VersionRange.fromRawValue(value)
